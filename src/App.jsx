...
const LIBRARY = [
  { category: "Orientamento", color: "#0072B2", shape: "circle", symbols: [
    { id: "ingresso", name: "Ingresso", src: sym("/simboli/01_ingresso.svg") },
    { id: "uscita", name: "Uscita", src: sym("/simboli/02_uscita.svg") },
    { id: "inizio", name: "Inizio percorso di mostra", src: sym("/simboli/03_inizio-percorso-mostra.svg") },
    { id: "fine", name: "Fine percorso di mostra", src: sym("/simboli/04_fine-percorso-mostra.svg") },
    { id: "direzione", name: "Direzione percorso di mostra", src: sym("/simboli/05_direzione-percorso-mostra.svg") },
    { id: "ascensore", name: "Ascensore", src: sym("/simboli/06_ascensore.svg") },
    { id: "scale", name: "Scale", src: sym("/simboli/07_scale.svg") },
    { id: "tu_sei_qui", name: "Tu sei qui", src: sym("/simboli/08_tu-sei-qui.svg") },
  ]},
  { category: "Servizi", color: "#E69F00", shape: "square", symbols: [
    { id: "biglietteria", name: "Biglietteria", src: sym("/simboli/11_biglietteria.svg") },
    { id: "bagno", name: "Bagno", src: sym("/simboli/12_bagno.svg") },
    { id: "bar", name: "Bar", src: sym("/simboli/13_bar.svg") },
    { id: "guardaroba", name: "Guardaroba", src: sym("/simboli/14_guardaroba.svg") },
    { id: "bookshop", name: "Bookshop", src: sym("/simboli/15_bookshop.svg") },
    { id: "gel", name: "Gel igienizzante", src: sym("/simboli/16_gel-igienizzante.svg") },
    { id: "infermeria", name: "Infermeria", src: sym("/simboli/17_infermeria.svg") },
    { id: "panchina", name: "Area di sosta", src: sym("/simboli/18_area-sosta.svg") },
  ]},
  { category: "Contenuti", color: "#56B4E9", shape: "triangle", symbols: [
    { id: "reperto", name: "Oggetto esposto", src: sym("/simboli/21_oggetto-esposto.svg") },
    { id: "audio_racconto", name: "Audio racconto", src: sym("/simboli/22_audio-racconto.svg") },
    { id: "video", name: "Video proiezione", src: sym("/simboli/23_video-proiezione.svg") },
    { id: "testo", name: "Testo", src: sym("/simboli/24_testo.svg") },
    { id: "aula", name: "Aula didattica", src: sym("/simboli/25_aula-didattica.svg") },
    { id: "toccare_si", name: "Toccare consentito", src: sym("/simboli/26_toccare-consentito.svg") },
    { id: "toccare_no", name: "Toccare non consentito", src: sym("/simboli/27_toccare-non-consentito.svg") },
  ]},
  { category: "Accessibilità", color: "#009E73", shape: "diamond", symbols: [
    { id: "acc_motoria", name: "Accessibilità motoria", src: sym("/simboli/31_accessibilita-motoria.svg") },
    { id: "mappa_tattile", name: "Mappa tattile", src: sym("/simboli/32_mappa-tattile.svg") },
    { id: "lis", name: "LIS", src: sym("/simboli/33_lis.svg") },
    { id: "caa", name: "CAA", src: sym("/simboli/34_caa.svg") },
    { id: "bagno_acc", name: "Bagno accessibile", src: sym("/simboli/35_bagno-accessibile.svg") },
  ]},
  { category: "Sicurezza", color: "#D55E00", shape: "hexagon", symbols: [
    { id: "emergenza", name: "Uscita di emergenza", src: sym("/simboli/41_uscita-emergenza.svg") },
    { id: "punto_raccolta", name: "Punto di raccolta", src: sym("/simboli/42_punto-raccolta.svg") },
    { id: "dae", name: "Defibrillatore", src: sym("/simboli/44_defibrillatore.svg") },
  ]},
];
